        ...
        <>
            ...
            <View style={{ height: "100%", justifyContent: "center" }}>
                <View style={styles.container}>
                    ...
                    <TouchableOpacity style={[styles.userNumber, styles.userNumber5, mapping[currentIndex] === 5 && { borderWidth: 0, backgroundColor: 'inherit' }]}>
                    ...
                    <TouchableOpacity style={[styles.userNumber, styles.userNumber6, mapping[currentIndex] === 6 && { borderWidth: 0, backgroundColor: 'inherit' }]}>
                    ...
                    <TouchableOpacity style={[styles.userNumber, styles.userNumber7, mapping[currentIndex] === 7 && { borderWidth: 0, backgroundColor: 'inherit' }]}>
                    ...
                    <TouchableOpacity style={[styles.userNumber, styles.userNumber8, mapping[currentIndex] === 8 && { borderWidth: 0, backgroundColor: 'inherit' }]}>
                    ...
                    <TouchableOpacity style={[styles.userNumber, styles.userNumber9, mapping[currentIndex] === 9 && { borderWidth: 0, backgroundColor: 'inherit' }]}>
                    ...
                    <TouchableOpacity style={[styles.userNumber, styles.userNumber10, mapping[currentIndex] === 10 && { borderWidth: 0, backgroundColor: 'inherit' }]}>
