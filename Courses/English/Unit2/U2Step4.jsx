...
export default function U2Step4() {
    ...
    const audios = [
        { url: "https://ukkibackend.soof.uz/media/audio/CD1-15-1.mp3", correct: "img1" },
        { url: "https://ukkibackend.soof.uz/media/audio/CD1-15-2.mp3", correct: "img2" },
        { url: "https://ukkibackend.soof.uz/media/audio/CD1-15-3.mp3", correct: "img3" },
        { url: "https://ukkibackend.soof.uz/media/audio/CD1-15-4.mp3", correct: "img4" },
        { url: "https://ukkibackend.soof.uz/media/audio/CD1-15-5.mp3", correct: "img5" },
        { url: "https://ukkibackend.soof.uz/media/audio/CD1-15-6.mp3", correct: "img6" },
    ];
    ...
    return (
        <>
            <View style={Styles.stepContainer}>
                ...
                {showQuestion && <Text style={styles.question}>❓ Bu qaysi rasm?</Text>}
