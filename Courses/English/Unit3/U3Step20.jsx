...
export default function U3Step20({ next }) {
  const audios = [
    "https://ukkibackend.soof.uz/media/audio/CD1-56-1.mp3",
    "https://ukkibackend.soof.uz/media/audio/CD1-56-2.mp3",
    "https://ukkibackend.soof.uz/media/audio/CD1-56-3.mp3",
    "https://ukkibackend.soof.uz/media/audio/CD1-56-4.mp3",
  ];
  ...
  const images = [
    ...
    { id: 1, src: require("../../../assets/images/w122.jpg"), name: "panda" },
    {
      id: 2,
      src: require("../../../assets/images/ruchka13.jpg"),
      name: "ruchka",
    },
    { id: 3, src: require("../../../assets/images/w123.jpg"), name: "kitob" },
  ];
  ...
  const handleSelect = (item) => {
    ...
    if (["panda", "toshbaqa"].includes(item.name)) {
      ...
      {dictionary ? (
        ...
        <View style={Styles.stepContainer}>
          <ThreeButtons
            ...
            audioUrl="https://ukkibackend.soof.uz/media/audio/Bilag’on bolajon, T tovushi bilan boshlanadigan so’zlarni belgila. .mp3"
          />
          ...
          {allPlayed && (
            <Text style={styles.question}>
              "T" harfi bilan boshlangan rasmni toping.
            </Text>
          )}
