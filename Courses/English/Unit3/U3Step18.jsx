        ...
        <>
            <View style={Styles.stepContainer}>
                ...
                <View style={styles.imageBlock}>
                    <Image style={styles.Image} source={require('../../../assets/images/unit-3/w101.jpg')} />
                ...
                <View style={styles.options}>
                    <TouchableOpacity style={styles.imgBtn} onPress={() => handlePress('baliq')}>
                        <Image style={styles.imgOption} source={require('../../../assets/images/unit-3/w103.jpg')} />
                    </TouchableOpacity>

                    <TouchableOpacity style={styles.imgBtn} onPress={() => handlePress('chumchuq')}>
                        <Image style={styles.imgOption} source={require('../../../assets/images/unit-3/w102.png')} />
                    </TouchableOpacity>

                    <TouchableOpacity style={styles.imgBtn} onPress={() => handlePress('deraza')}>
                        <Image style={styles.imgOption} source={require('../../../assets/images/unit-3/w104.jpg')} />
                    </TouchableOpacity>
                </View>
