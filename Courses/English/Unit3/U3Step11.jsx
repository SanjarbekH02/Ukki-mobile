    ...
    const handleImagePress = async (index) => {
        if (correctIndexes[currentIndex] === index) {
            ...
            if (nextIndex < audios.length) {
                ...
                setAllCorrect(true) // ✅ hammasi tugadi
            }
        } else {
            setFeedback('Notogri!')
            setIsError(true)
        ...
        <>
            <View style={Styles.container}>
                ...
                <View style={styles.imgGrid}>
                    {images.map((img, i) => (
                        <TouchableOpacity key={i} style={styles.imgBox} onPress={() => handleImagePress(i)}>
...
const styles = StyleSheet.create({
    imgGrid: {
        ...
        marginTop: 10,
        position: 'relative', // ✅ tugma ustida chiqishi uchun
    },
    imgBox: {
        width: '48%',
        aspectRatio: 1,
    ...
    playBtn: {
        position: 'absolute',
        top: '40%', // ekranning o‘rtasiga yaqin
        left: '50%',
