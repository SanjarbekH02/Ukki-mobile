...
const AudioPlayerScreen = ({next}) => {
    ...
    const handleNextPress = () => {
        stopSound();
        console.log("Keyingi sahifa yoki audio qo‘shish mumkin");
    };
    ...
    return (
        <View style={styles.container}>
            <ThreeButtons audioUrl="https://ukkibackend.soof.uz/media/audio/ad9c2f34-e973-422c-8641-024bc5db66e9.mp3"
        ...
        {sound && !hasFinished && (
          <TouchableOpacity style={styles.stopButton} onPress={stopSound}>
            <Text style={styles.buttonText}>⏹️ To'xtat</Text>
          </TouchableOpacity>
        )} */}
            </View>
