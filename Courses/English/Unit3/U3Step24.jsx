...
export default function U3Step24({ next }) {
    ...
    const items = [
        { id: 1, audio: "https://ukkibackend.soof.uz/media/audio/CD1-57-1.mp3", img: require('../../../assets/images/cd57.jpg'), text: "Scooter - Skuter" },
        { id: 2, audio: "https://ukkibackend.soof.uz/media/audio/CD1-57-2.mp3", img: require('../../../assets/images/cd571.jpg'), text: "Flashlight - Chiroq" },
        { id: 3, audio: "https://ukkibackend.soof.uz/media/audio/CD1-57-3.mp3", img: require('../../../assets/images/vd572.jpg'), text: "Electric guitar - Elektr gitara" },
      ]
...
const styles = StyleSheet.create({
    ...
    bigImage: { width: 300, height: 300, borderRadius: 10, resizeMode: 'stretch', borderRadius: 15},
