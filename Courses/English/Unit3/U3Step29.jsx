...
export default function Step17({ next }) {
    ...
    const audios = [
        "https://ukkibackend.soof.uz/media/audio/CD1-59-2.mp3",
        "https://ukkibackend.soof.uz/media/audio/CD1-59-1.mp3",
        "https://ukkibackend.soof.uz/media/audio/CD1-59-4.mp3",
        "https://ukkibackend.soof.uz/media/audio/CD1-59-3.mp3",
    ];

    const images = [
        require("../../../assets/images/unit-3/cd59.jpg"),
        require("../../../assets/images/unit-3/cd591.jpg"),
        require("../../../assets/images/unit-3/cd592.jpg"),
        require("../../../assets/images/unit-3/cd593.jpg"),

    ];

    const correctIndexes = [3, 0, 1, 2]; // to‘g‘ri rasm indekslari
    ...
    const borderColors = ["orange", "green", "skyblue", "red"];
                ...
                <View style={styles.imgGrid}>
                    {images.map((img, i) => (
                        <TouchableOpacity
                            ...
                            style={[
                                styles.imgBox,
                                { borderColor: borderColors[i], borderWidth: 5, borderRadius: 15 }, // index orqali rang berish
                            ]}
