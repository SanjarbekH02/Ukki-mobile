...
const questions = [
  {
    id: 1,
    audio: "https://ukkibackend.soof.uz/media/audio/CD1-45-1.mp3",
    answer: "d",
    images: [
      { id: "a", src: require("../../../assets/images/unit-3/cd453.jpg") },
      { id: "b", src: require("../../../assets/images/unit-3/cd455.jpg") },
      { id: "c", src: require("../../../assets/images/unit-3/cd454.jpg") },
      { id: "d", src: require("../../../assets/images/unit-3/cd451.jpg") },
      { id: "e", src: require("../../../assets/images/unit-3/cd452.jpg") },
    ],
  },
  {
    id: 2,
    audio: "https://ukkibackend.soof.uz/media/audio/CD1-45-2.mp3",
    answer: "e",
    images: [
      { id: "a", src: require("../../../assets/images/unit-3/cd453.jpg") },
      { id: "b", src: require("../../../assets/images/unit-3/cd455.jpg") },
  ...
  {
    id: 3,
    audio: "https://ukkibackend.soof.uz/media/audio/CD1-45-3.mp3",
    answer: "a",
    images: [
      { id: "a", src: require("../../../assets/images/unit-3/cd453.jpg") },
      { id: "b", src: require("../../../assets/images/unit-3/cd455.jpg") },
  ...
  {
    id: 4,
    audio: "https://ukkibackend.soof.uz/media/audio/CD1-45-4.mp3",
    answer: "c",
    images: [
      { id: "a", src: require("../../../assets/images/unit-3/cd453.jpg") },
      { id: "b", src: require("../../../assets/images/unit-3/cd455.jpg") },
  ...
  {
    id: 5,
    audio: "https://ukkibackend.soof.uz/media/audio/CD1-45-5.mp3",
    answer: "b",
    images: [
      { id: "a", src: require("../../../assets/images/unit-3/cd453.jpg") },
      { id: "b", src: require("../../../assets/images/unit-3/cd455.jpg") },
  ...
  return (
    <>
      <View style={styles.container}>
        ...
        <Text style={styles.instruction}>Aytilgan rasmni ustiga bosing</Text>
