...
const U3Step22 = ({next}) => {
    ...
    const localImages = [
        require('../../../assets/images/unit-3/cd60.jpg'),
        require('../../../assets/images/unit-3/cd601.jpg'),
        require('../../../assets/images/unit-3/cd602.jpg'),
        require('../../../assets/images/unit-3/cd603.jpg'),
        require('../../../assets/images/unit-3/cd604.jpg'),
        require('../../../assets/images/unit-3/cd605.jpg'),
    ];

    const audioFiles = [
        'https://ukkibackend.soof.uz/media/audio/CD1-60-1.mp3',
        'https://ukkibackend.soof.uz/media/audio/CD1-60-2.mp3',
        'https://ukkibackend.soof.uz/media/audio/CD1-60-3.mp3',
        'https://ukkibackend.soof.uz/media/audio/CD1-60-4.mp3',
        'https://ukkibackend.soof.uz/media/audio/CD1-60-5.mp3',
        'https://ukkibackend.soof.uz/media/audio/CD1-60-6.mp3',
    ];
    ...
    const initializeGame = () => {
        ...
        const correctMappings = [3, 5, 0, 4, 2, 1];
    ...
    const handleImageSelect = (selectedImageIndex) => {
        ...
        if (isCorrect) {
            ...
            // Faqat to'g'ri bo'lsa raqamni "used" ga qo'shamiz
            setUsedAnswers(prev => [...prev, selectedImageIndex + 1]);
        } else {
            setIsError(true);
            setTimeout(() => setIsError(false), 1000);
            // ❌ Xato bo'lsa usedAnswers ga qo'shmaymiz
        }

        // Har doim keyingi audio
